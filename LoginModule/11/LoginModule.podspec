...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/chimj1/Login"
  ...
  s.source       = { :git => "https://github.com/chimj1/Login.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LoginModule/LoginModule/**/*.{h,m,swift}"
  ...
  # s.resource  = "icon.png"
  s.resources = "LoginModule/LoginModule/Resources/*.pdf"
