...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/chimj1/MJBase"
  ...
  s.source       = { :git => "https://github.com/chimj1/MJBase.git", :tag => s.version.to_s }
  ...
  s.source_files  = "MJBase/MJBase/**/*.{h,m,swift}"
  ...
  #
  s.resources = "MJBase/MJBase/Resources/**/**/*.{bundle,png,jpg}"
  # s.resource  = "icon.png"
